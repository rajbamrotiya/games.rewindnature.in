...
export default function Checkers() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-[#0b0f19] text-slate-900 dark:text-slate-100 flex flex-col items-center py-6 px-4 font-sans transition-colors duration-300 relative overflow-hidden selection:bg-indigo-500 selection:text-white">
            ...
            <div className="relative z-10 w-full max-w-4xl grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-8 lg:gap-12">
                <div className="w-full max-w-[550px] mx-auto bg-neutral-200 dark:bg-neutral-800 rounded-lg p-2 shadow-xl border border-neutral-300 dark:border-neutral-700">
                    <div className="grid grid-cols-8 grid-rows-8 border-4 border-[#5d3b24] dark:border-[#3a2212] aspect-square bg-[#debe98]">
